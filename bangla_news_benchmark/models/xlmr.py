...
def train_xlmr(data_dict, config):
    """
    Train XLM-RoBERTa model with Accelerate
    ...
    print(f"\nTraining XLM-RoBERTa for {num_epochs} epochs...")
        ...
        if accelerator.is_local_main_process:
            ...
            if val_loss_meter.avg < best_val_loss:
                ...
                unwrapped_model.save_pretrained(
                    config.get('model_save_path', 'checkpoints/xlmr_best'),
    ...
    if accelerator.is_local_main_process:
        ...
        return {
            ...
            'model_path': config.get('model_save_path', 'checkpoints/xlmr_best'),
...
if __name__ == "__main__":
    ...
    data_dict = dataset.prepare_for_transformers("xlm-roberta-base")
    ...
    # Train model
    results = train_xlmr(data_dict, config)
    if results:
